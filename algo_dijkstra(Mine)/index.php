...
function initialize() {	
	...
	var mapOptions = {
		zoom: 13,
		center: new google.maps.LatLng(22.576648, 88.413706)
	};
...
function send_dijkstra(){
	...
	if(markeruser == '' || markerdestination == ''){
		alert('Fill out the user & destination coordinates first');
		return false;
	}
...
echo '</select>';
?>
<span><button onclick="send_dijkstra()" id='run_dijkstra'>RUN</button><span id='loading' style='display:none'>Creating route...</span></span>
